				   ...
				   bool is_percpu)
{
	...
	void __user *uvalues = (void __user *)u64_to_user_ptr((u64)attr->batch.values);
	void __user *ukeys = (void __user *)u64_to_user_ptr((u64)attr->batch.keys);
...
after_loop:
	...
	ubatch = (void __user *)u64_to_user_ptr((u64)attr->batch.out_batch);
